...
mixin _$HistoryState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<HistoryEntry> entries) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<HistoryEntry> entries)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<HistoryEntry> entries) : _entries = entries;
  ...
  @override
  String toString() {
    return 'HistoryState.loaded(entries: $entries)';
  }
...
abstract class _Loaded implements HistoryState {
  const factory _Loaded(final List<HistoryEntry> entries) = _$LoadedImpl;
